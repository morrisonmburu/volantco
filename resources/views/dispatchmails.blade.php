...
<div class="col-lg-12 card fill">
	...
	<div class="card-body" id="express"> 
		...
		<div>
			<strong>Driver's Name or Email</strong>
			<p class="text-center">{{ $driver_name }}</p>
		</div>
		<div>
			<strong>Driver's Phone Number</strong>
			<p class="text-center">{{ $driver_phone }}</p>
		</div>
		<div>
			<strong>Order <span>{{ $order_id }}</span> Dispatched at</strong>
			<p class="text-center">{{ $dispatch_time }}</p>
		</div>
