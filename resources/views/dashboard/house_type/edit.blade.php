			...
			<div class="panel panel-bd lobidrag lobipanel lobipanel-sortable" data-inner-id="gAaGWkWzd2" data-index="0">
				<div class="panel-heading ui-sortable-handle">
					...
					<div class="panel-body">
						...
						{!! Form::open(['action'=> ['houseTypeController@update', $data->id], 'method'=>'POST'], ['class'=>'col-sm-6']) !!}
						<div class="form-group">
							<label> House Title<font color="red">*</font></label>
							{{Form::text('title', $data->title, ['required'=>"", 'class'=>'form-control', 'placeholder'=>'Enter House Title'])}}
						</div> 

						<div class="form-group">
							<label>Least Room Counts<font color="red">*</font></label>
							{{Form::number('room_counts', $data->least_room_counts, ['required'=>"", 'class'=>'form-control', 'placeholder'=>'Least Room Counts'])}}
						</div>  

						<div class="form-group">
							<label>Price<font color="red">*</font></label>
							{{Form::number('price', $data->price, ['required'=>"", 'class'=>'form-control', 'placeholder'=>'Price'])}}
						</div>                                    
