		...
		<div class="col-sm-12 lobipanel-parent-sortable ui-sortable" data-lobipanel-child-inner-id="yy9ycBRabT">
			<div class="panel panel-bd lobidrag lobipanel lobipanel-sortable" data-inner-id="yy9ycBRabT" data-index="0">
				<div class="panel-heading ui-sortable-handle">
					<div class="btn-group"> 
						<a class="btn btn-success" href="/house_type/create"> <i class="fa fa-plus"></i> Add House Type</a> 
					</div>
					...
					<div class="panel-body">
						...
						<div class="table-responsive">
							<table class="table table-bordered table-hover" style="overflow-x:auto;border-collapse: collapse; white-space: nowrap;">
								<thead>
									<tr>
										<th>Id</th>
										<th>Title</th>
										<th>Least Room Counts</th>
										<th>Price</th>
										<th>action</th>
									</tr>
								</thead>
								<tbody>
									...
									<tr>
										...
										<td>
											{{$house->least_room_counts}}
										</td>
										<td>
											{{$house->price}}
										</td>
										<td>
											<a href="/house_type/{{$house->id}}/edit" class="btn btn-info btn-xs pull-left" data-toggle="tooltip" data-placement="left" title="Update">
												<i class="fas fa-pen-square"></i>
											</a>
											{!! Form::open(['action'=> ['houseTypeController@destroy',$house->id], 'method'=>'POST'], ['class'=>'col-sm-6']) !!}
											<button href="/house_type/{{$house->id}}/destroy" class="btn btn-danger btn-xs pull-right " data-toggle="tooltip" data-placement="right" title="Delete ">
