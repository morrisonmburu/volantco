			...
			<div class="panel panel-bd lobidrag lobipanel lobipanel-sortable" data-inner-id="gAaGWkWzd2" data-index="0">
				<div class="panel-heading ui-sortable-handle">
					...
					<div class="panel-body">
						...
						{!! Form::open(['action'=> ['truckController@update', $data->id], 'method'=>'POST'], ['class'=>'col-sm-6']) !!}
						<div class="form-group">
							<label> Number<font color="red">*</font></label>
							{{Form::number('truckNo', $data->truckNo, ['required'=>"", 'class'=>'form-control', 'placeholder'=>'Enter Number'])}}
						</div>

						<div class="form-group">
							<label>Type<font color="red">*</font></label>
							{{Form::select('truckType', ['Truck'=>'Truck', 'Trailer'=>'Trailer'], $data->truckType, ['required'=>"", 'class'=>'form-control'])}}
						</div>
						...
						<div class="form-group">
							...
							{{Form::select('ownership', ['Company Owned'=>'Company Owned', 'Owner Operator'=>'Owner Operator'], $data->ownerShipType, ['required'=>"", 'class'=>'form-control'])}}
						</div>

						<label>Note</label><br>

						{{Form::textarea('comments', $data->comments, ['required'=>"", 'class'=>'form-control', 'rows'=>'4', 'placeholder'=>'problem'])}}                                    
