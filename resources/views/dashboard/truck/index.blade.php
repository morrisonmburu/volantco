							...
							<table class="table table-bordered table-hover" style="overflow-x:auto;border-collapse: collapse; white-space: nowrap;">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<a href="/truck/{{$truck->id}}/edit" class="btn btn-info btn-xs pull-left" data-toggle="tooltip" data-placement="left" title="Update">
												<i class="fa fa-pencil" aria-hidden="true">

												</i>
											</a>
											{!! Form::open(['action'=> ['truckController@destroy',$truck->id], 'method'=>'POST'], ['class'=>'col-sm-6']) !!}
											<button href="/truck/{{$truck->id}}/destroy" class="btn btn-danger btn-xs pull-right " data-toggle="tooltip" data-placement="right" title="Delete ">
