		...
		<div class="col-sm-12 lobipanel-parent-sortable ui-sortable" data-lobipanel-child-inner-id="cpa90TSeTV">
			<div class="panel panel-bd lobidrag lobipanel lobipanel-sortable" data-inner-id="cpa90TSeTV" data-index="0">
				<div class="panel-heading ui-sortable-handle">
					<div class="btn-group"> 
						<a style="background-color:#26a69a; border-color: #26a69a"  class="btn btn-success" href="\dispatch\"> <i class="fa fa-plus"></i> Go back</a> 
					</div>
							...
							<div class="panel panel-info">
								...
								<div class="panel-footer">
									...
									<span class="pull-right">
										<a title="Delete" href="/dispatch/{{$data->id}}/destroy" data-original-title="Remove this user" data-toggle="tooltip" type="button" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-remove"></i></a>&nbsp;
									</span>
								</div>
