												...
												<tr>
													...
													<td>
														<div class="row">
															...
															<button href="/orders/{{$order->id}}/destroy" class="btn btn-danger btn-xs pull-right" data-toggle="tooltip" data-placement="right" title="Delete">
															...
															<a href="/orders/{{$order->id}}" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="left" title="View"><i class="fa fa-eye" aria-hidden="true"></i></a>

															<a href="/orders/{{$order->id}}/dispatch" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="left" title="Dispatch"><i class="fa fa-truck" aria-hidden="true"></i></a>
														</div>
													</td>
												</tr>
												@endif
