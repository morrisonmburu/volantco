				...
				<div class="panel panel-bd lobidrag lobipanel lobipanel-sortable" data-inner-id="ekiAi16e04" data-index="0">
					<div class="panel-heading ui-sortable-handle">
						...
						<div class="panel-body">
							...
							{!! Form::open(['action'=> 'locationsController@store', 'method'=>'POST'], ['class'=>'col-sm-12']) !!}
										...
										<tbody>
													...
													<tr>
															<td bgcolor=""><div class="col-sm-10 form-group">
																...
																{{ Form::text('location', old('location'), ['class' => "form-control", 'placeholder' => "Location Name", 'id' => 'location']) }}
																</div>
															</div>
														</td>
													</tr>
