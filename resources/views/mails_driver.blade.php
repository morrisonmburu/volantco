...
<div class="col-lg-12 card fill">
	...
	<div class="card-body" id="express"> 
		...
		<div>
			...
			<span class="badge badge-pill badge-warning">{{ $contact_no }}</span>
		</div>
		<div>
			<div>
				<p>To Activate Your Account Press the Link below</p>
			</div>
			<a href="https://volantco.net/driverVerification/{{ $token }}" class="btn btn-info btn-block" >Activate Your Account</a>
		</div>

		<div>
			<div>
				<p> Here is your login details for the riders app, please keep your login credentials safe or otherwise hidde.</p>
				<p>Email: {{ $email }}</p>
				<p>Password: {{ $rider_password }}</p>
			</div>
		</div>
...
@component('mail::button', ['url' => 'https://volantltd.com/'])
